...
PIPELINE_ROOT = 'gs://mlops-poc-vertexai-databydepew-bucket/pipeline_root'
PIPELINE_JOB_RUNNER_SERVICE_ACCOUNT = 'vertex-pipelines@mlops-poc-vertexai.iam.gserviceaccount.com'

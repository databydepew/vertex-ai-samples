...
ARTIFACT_REPO_NAME="databydepew-artifact-registry"
BASE_DIR="AutoMLOps/"
BUILD_TRIGGER_LOCATION="us-central1"
BUILD_TRIGGER_NAME="databydepew-build-trigger"
PIPELINE_JOB_SUBMISSION_SERVICE_IMAGE="us-central1-docker.pkg.dev/mlops-poc-vertexai/databydepew-artifact-registry/databydepew/submission_service:latest"
PIPELINE_JOB_SUBMISSION_SERVICE_LOCATION="us-central1"
PIPELINE_JOB_SUBMISSION_SERVICE_NAME="databydepew-job-submission-svc"
PIPELINE_JOB_RUNNER_SERVICE_ACCOUNT_SHORT="vertex-pipelines"
PIPELINE_JOB_RUNNER_SERVICE_ACCOUNT_LONG="vertex-pipelines@mlops-poc-vertexai.iam.gserviceaccount.com"
PROJECT_ID="mlops-poc-vertexai"
PUBSUB_TOPIC_NAME="databydepew-queueing-svc"
SCHEDULE_NAME="databydepew-schedule"
SCHEDULE_PATTERN="59 11 * * 0"
SCHEDULE_LOCATION="us-central1"
SOURCE_REPO_NAME="mlops-poc-vertexai"
SOURCE_REPO_BRANCH="develop"
STORAGE_BUCKET_NAME="mlops-poc-vertexai-databydepew-bucket"
